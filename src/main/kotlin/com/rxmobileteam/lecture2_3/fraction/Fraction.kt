...
class Fraction private constructor(
  ...
  operator fun plus(other: Fraction): Fraction =
    if(denominator == other.denominator) {
      ...
      Fraction(numerator * other.denominator + other.numerator * denominator,
  ...
  override fun equals(other: Any?): Boolean = other is Fraction && numerator * other.denominator == other.numerator * denominator
...
operator fun Fraction.get(index: Int): Int =
  when (index) {
      0 -> numerator
      1 -> denominator
      else -> throw Exception("Invalid index for Fraction")
  }
//endregion
