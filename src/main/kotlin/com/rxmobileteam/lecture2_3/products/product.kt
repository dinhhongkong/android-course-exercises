...
fun List<Product>.sortedByPriceAscendingThenByFavoriteCountDescending(): List<Product> = this.sortedWith(compareBy<Product> { it.price }.thenByDescending { it.favoriteCount })
...
fun Order.getMaxPriceProduct(): Product = this.products.maxByOrNull { it.price } ?: throw Exception("Order is empty")

// TODO: Return the product with the min price in the order
fun Order.getMinPriceProduct(): Product = this.products.minByOrNull { it.price } ?: throw Exception("Order is empty")
